...
import { Loader2, Folders, ChevronRight, CheckSquare } from "lucide-react";
    ...
    <div className="min-h-screen p-8 sm:p-12 flex flex-col">
      <div className="max-w-5xl mx-auto w-full">
        ...
        <p className="text-slate-500 font-medium text-lg max-w-2xl mb-12">
          Select a project portfolio below to view its dedicated to-do list,
          manage tasks, and track specific completion goals.
        </p>
        ...
        {isError ? (
          ...
          <div className="text-center bg-white rounded-3xl border border-slate-100 shadow-sm py-32 px-10">
            ...
            <p className="text-slate-500 font-medium">
              There are currently no active mapped projects to display.
            </p>
          </div>
        ) : (
              ...
              >
                <div>
                    ...
                    <span
                      className={`px-2.5 py-1 rounded text-[10px] uppercase font-bold tracking-widest ${
                        project.status.toUpperCase() === "ACTIVE"
                          ? "bg-blue-100 text-blue-700 outline outline-1 outline-blue-200/50"
                  ...
                  <p className="text-sm text-slate-500 font-medium line-clamp-2">
                    {project.description ||
                      "No specific details provided for this trajectory scope."}
                  </p>
                </div>
