...
import { Loader2, Folders, ChevronRight, CalendarDays } from "lucide-react";
        ...
        <div className="flex items-center gap-5 mb-10">
          ...
          <div>
            ...
            <p className="text-sm font-bold uppercase tracking-widest text-blue-600">
              Gantt Chart Explorer
            </p>
          </div>
        </div>

        <p className="text-slate-500 font-medium text-lg max-w-2xl mb-12">
          Select a project portfolio below to view its detailed master
          scheduling canvas and horizontal development tracker.
        </p>
