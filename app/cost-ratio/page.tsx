...
import { Loader2, Folders, ChevronRight, Coins } from "lucide-react";
import Link from "next/link";
import { Project } from "@/types/database";
import { ErrorState } from "@/components/ErrorState";

export default function CostRatioIndexPage() {
        ...
        <div className="flex items-center gap-5 mb-10">
          ...
          <div>
            ...
            <p className="text-sm font-bold uppercase tracking-widest text-blue-600">
              Sponsorship — Cost vs Value Breakdown
            </p>
          </div>
        </div>

        <p className="text-slate-500 font-medium text-lg max-w-2xl mb-12">
          Select a project below to view and manage its sponsorship cost ratio breakdown.
        </p>
